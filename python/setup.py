...
TEMP_PATH = "deps"
SPARK_HOME = os.path.abspath("../../../Documents/spark/spark-3.3.0-bin-hadoop3/")
...
if len(JARS_PATH) == 1:
    JARS_PATH = JARS_PATH[0]
        ...
        "../../../Documents/spark/spark-3.3.0-bin-hadoop3/RELEASE") and len(glob.glob("../jars/spark*core*.jar")) == 1):
